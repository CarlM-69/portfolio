	...
	return (
		<>
			<div className="container">
				<div className="child"><span className="main-title">MY PORTFOLIO</span></div>
				<div className="child"><span className="main-subtitle" id="subtitle">I'm Carl Mathew Gabay.</span></div>
				<div className="child">
